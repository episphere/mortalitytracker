...
dtrack.plotlyCompare=async(div='plotlyCompareDiv')=>{
    ...
    let traceAvg={ // dev2021
        x:dtrack.data.weekends20201,
        y:valueRange.avg.concat(valueRange.avg).concat(valueRange.avg).concat(valueRange.avg).slice(0,trace2020.y.length),
        type: 'scatter',
        mode: 'lines+markers',
...
dtrack.plotlyWithCovid=async(div='plotlyWithCovidDiv')=>{
    ...
    */
    ...
    let traceAvg={
        ...
        y:valueRange.avg.concat(valueRange.avg).concat(valueRange.avg).concat(valueRange.avg),
        type: 'scatter',
        mode: 'lines',
    ...
    */
    var traceMin = {
      x: traceAvg.x,
      y: valueRange.min.concat(valueRange.min).concat(valueRange.min).concat(valueRange.min),
      fill: 'toself',
      type: 'scatter',
      mode: 'none',
      fillcolor: 'rgba(200,200,200,0)',
    ...
    var traceMax = {
      x: traceAvg.x,
      y: valueRange.max.concat(valueRange.max).concat(valueRange.max).concat(valueRange.max),
      fill: 'tonexty',
      type: 'scatter',
      mode: 'none',
