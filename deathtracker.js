...
dtrack.plotlyCompare=async(div='plotlyCompareDiv')=>{
    ...
    var traceExcess = {
        ...
        type: 'scatter',
        mode: 'lines',
        name: '<span style="font-size:12">Additional<br>mortality,<br><span style="font-size:10">unadjusted for<br>demographic<br>shifts (**)</span></span>',
        line: {
